...
| [011](011-royalty-calculation-api.md) | Royalty calculation API | Mutation honesty improved, but the pre-edit gate was skipped and placeholders implemented later rules early | Explicit cycle checkpoint and scaffold restrictions |
