...
| [013](013-loan-eligibility-api.md) | Loan eligibility API | RED sequencing improved, but independent rules were batched and task-new tests were relabeled as guards | Evidence only; no skill change |
