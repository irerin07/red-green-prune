...
| [015](015-program-eligibility-api.md) | Program eligibility API | Slightly higher complexity revived decision batching and deliberate placeholder scaffolding | Evidence for responsibility split; no skill text change ([PR #23](https://github.com/irerin07/red-green-prune/pull/23)) |
